...
public class client2nd implements ActionListener,Runnable{
...
//                or
        ...
        JLabel status = new JLabel("Guddu, Kaleen, Bablu,Sweety");
...
//        System.out.println(output); //code debugging only
    ...
    public static void main(String[] args) throws IOException {
        client2nd second = new client2nd();
