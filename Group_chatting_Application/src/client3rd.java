...
public class client3rd implements ActionListener,Runnable{
...
//                or
        ...
        JLabel status = new JLabel("Sweety,Kaleen, Guddu, Bablu");
...
//        System.out.println(output); //code debugging only
    ...
    public static void main(String[] args) throws IOException {
        client3rd third = new client3rd();
        Thread thread = new Thread(third);
        thread.start();
