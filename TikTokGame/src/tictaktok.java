...
public class tictaktok implements ActionListener{
    ...
    tital_panel.setLayout(new BorderLayout());
    tital_panel.setBounds(0,0,800,100);
    ...
    tital_panel.add(textfield);
    frame.add(tital_panel,BorderLayout.NORTH);
